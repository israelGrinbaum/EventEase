            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <asp:Repeater ID="RPTPortions" runat="server">
                          <ItemTemplate>
                                <tr>
                                    <td><%# Eval("Pid") %></td>
                                    <td><%# Eval("Pname") %></td>
                                    ...
                                    <td><%# Eval("price") %></td>
                                    <td><%# Eval("picName") %></td>
                                    <td><%# Eval("portionCatId") %></td>
                                    <td><a href="addUpdatePortion.aspx?Cid=<%# Eval("Pid") %>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                    <td><a href="#" class="btn btn-danger" onclick="if(confirm('האם אתה בטוח?')) window.location='addUpdatePortion.aspx?Cid=<%# Eval("Pid") %>&op=del'"><i class="fa-solid fa-trash-alt"></i></a> </td>
                                </tr>
                          </ItemTemplate>
                      </asp:Repeater>
                  </tbody>
