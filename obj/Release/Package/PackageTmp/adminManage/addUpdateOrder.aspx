                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group form-floating">
                                ...
                                <label for="mainCnt_txtEventDate">תאריך אירוע</label>
                            </div>
                            <div class="form-group form-floating">
                                ...
                                <label for="mainCnt_txtSomePeople">כמות אנשים</label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-floating">
                                ...
                                <label for="PricePerPortion">מחיר למנה (אוטומטי בבחירת סוג אירוע)</label>
                            </div>
                            <div class="form-group">
                                <label>אולם</label>
                            ...
                            <div class="form-group form-floating">
                                <asp:TextBox ID="txtNotes" runat="server" class="form-control" placeholder="הכנס הערות" MaxLength="150"></asp:TextBox>
                                <label for="mainCnt_txtNotes">הערות</label>
                            </div>
